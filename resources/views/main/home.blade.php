...
<div class="home">
  <div id="eyecatch">
    <div class="title">
      <h1>FUKAGAWA-TEI</h1>
      <p>下町・深川の美味しいがそこにある</p>
    </div>
    <div class="number-box">
      <img class="logo" src="img/IMG_0674.gif">
      <div>
        <p>ご予約の方はこちらの電話番号まで</p>
        <a href="tel:080-1111-2222" id="number">080-1111-2222</a>
      </div>
    </div>
  </div>
  <div class="flex">
    ...
    <div class="concept-box">
      ...
      <div class="concept-img">
        <img src="img/bamboo-828703_1920.jpg">
        <img src="img/bridge-53769_1920.jpg">
      </div>
    </div>
  </div>
  <div class="flex">
    ...
    <a href="" class="btn btn-border">メニューへ</a>
  </div>
  <div class="access">
  ...
  <div class="flex">
    ...
    <div class="contact">
      ...
      <div class="num-box">
        <img src="../assets/icon_059850_256.png" alt="">
